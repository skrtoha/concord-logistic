                                ...
                                <tr class="" v-for="(ridx, idx) in goodsRows[0]">
                                    ...
                                    <td class="uk-visible@s v-cloak--hidden">
                                        ...
                                        <ol class="progressBar" style="margin: 10px 0;">
                                            <li class="" :class="[ridx.st[0]]"><span>На складе<br> в США</span></li>
                                            <li class="" :class="[ridx.st[1]]"><span>В пути</span></li>
                                            <li class="" :class="[ridx.st[2]]"><span>На складе в Москве</span></li>
                                            <li class="" :class="[ridx.st[3]]"><span>Выдан клиенту</span></li>
                                        </ol>
                                    </td>
                                    <td class="uk-visible@s v-cloak--hidden">
                                        {{ridx.n}}
